...
import "./AddReusableCouponModal.scss";
import { imageToBase64 } from "../../../utils/Base64Encoder";

const AddReusableCouponModal = ({
  isOpen,
  closeModal,
  handleAddCoupon,
  loading,
            ...
            <div className="middle">
              ...
              <div className="formGroup">
                ...
                >
                  ...
                  <option value="branch specific">Branch Spfecific</option>
                </select>
              </div>
              <div className="formGroup">
...
export default AddReusableCouponModal;
