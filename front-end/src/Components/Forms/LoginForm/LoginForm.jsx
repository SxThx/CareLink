...
const USE_MOCK_LOGIN = (() => {
  if (
    ...
    import.meta.env &&
    "VITE_USE_MOCK_LOGIN" in import.meta.env
  ) {
...
const MOCK_USERS = [
  {
    ...
    userData: {
      username: "caresync_admin",
      full_name: "caresync Admin",
      email: "admin@caresync.com",
      role: "super_admin",
      designation: "Super Administrator",
      approval_status: "approved",
      profile_image: "",
      company_name: "caresync HQ",
      company_logo: "",
      company_description:
        "Primary caresync administration account used for offline access.",
      company_contact_number: "555-0101",
      company_address: "123 caresync Way, Sample City",
      company_email: "contact@caresync.com",
      business_registration_number: "CL-0001",
      company_id: "mock-company-1",
    },
    successMessage: "Logged in as caresync Admin (offline mode).",
  },
  {
    ...
    userData: {
      ...
      approval_status: "approved",
      profile_image: "",
      company_name: "caresync Partners",
      company_logo: "",
      company_description:
        "Demo partner company for testing the console without a backend.",
      company_contact_number: "555-0202",
      company_address: "456 Partner Avenue, Example City",
      company_email: "partners@caresync.com",
      business_registration_number: "CL-0002",
      company_id: "mock-company-2",
    },
    successMessage: "Logged in as caresync Partner Admin (offline mode).",
  },
];
...
const completeMockLogin = (mockUser) => {
  ...
  dismissToast();
  showSuccessToast(
    mockUser.successMessage || "Logged in successfully (offline mode)."
  );
  setTimeout(() => {
...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const mockUser = USE_MOCK_LOGIN
      ? findMockUser(formData.email, formData.password)
      : null;
